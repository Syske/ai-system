...
| 2026-08-23 | weekly | 工具校验/周度巡检/一致性抽查 + 修复批次（提示词路径绝对化 + Windows 路径归一化） | `MAINTENANCE-2026-08-23.md` | 待确认：P26 状态置 Implemented；P28 补 README 提案索引；方案 3（根占位符填充）/方案 4（workflow-trigger 死模板）待立项 |
