...
| [P70](P70-OUTPUT-DISCIPLINE.md) | AI 输出纪律（Output Discipline） — **Proposed**（源自 caveman 外部评估的核实：采纳 输出压缩的内容级纪律 / 阶段回复形态 / 子代理输出契约 / 上下文两句原则；**排除**引入 caveman 本体与 -75% 指标；§4.1 五项待裁定） | 2026-09-23 |
