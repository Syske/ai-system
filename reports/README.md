...
| [P66](P66-CR-CHANGE-IMPACT-DERIVE.md) | code-review / change-impact 重复追问项目与分支（容器已记录服务与各自分支；P57 单候选契约只认字面量 `Branch` 而实际字段为 `Branch Mapping`/`Base Branch`→ 从未生效）— **Proposed** | 2026-09-21 |
