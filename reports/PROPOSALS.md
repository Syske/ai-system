...
| Proposed | 提示词渲染期解析根路径占位符（{workspace_root} 等，模板零改动） | 2026-08-23 | `P30-PROMPT-ROOT-PLACEHOLDERS.md` |
| Proposed | standards/cool 公司规范迁出通用层（extensions + loader 可配置） | 2026-08-23 | `P31-STANDARDS-COOL-MIGRATION.md` |
