...
* First-time change set scaffold is driven by openspec-cn new change during spec (/aic-propose); the chosen kebab-case name becomes the Change ID. Run it inside workspaces/{project_id}/ — openspec-cn locates the project by working directory.
